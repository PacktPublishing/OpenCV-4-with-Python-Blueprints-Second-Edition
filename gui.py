...
class BaseLayout(Meta1):
    ...
    def __init__(self, capture, title=None, parent=None, id=-1, fps=10):
        ...
        # /home/arsen/Workspace/opencv-python-blueprints/chapter1/gui.py:69: wxPyDeprecationWarning: Call to deprecated item BitmapFromBuffer. Use :meth:`wx.Bitmap.FromBuffer` or :meth:`wx.Bitmap.FromBufferAndAlpha` instead.
