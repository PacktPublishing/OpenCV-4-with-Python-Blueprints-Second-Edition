...
def recognize(img_gray):
    ...
    (num_fingers, img_draw) = detect_num_fingers(contours,
                                                 defects, img_draw)
...
def detect_num_fingers(contours, defects, img_draw, thresh_deg=80.0):
    ...
    for defect in defects[:, 0]:
        ...
        start_idx, end_idx, farthest_idx, _ = defect
